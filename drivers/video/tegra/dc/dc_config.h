...
#define TEGRA_WIN_FMT_T124_HIGH  (HIGHBIT(TEGRA_WIN_FMT_YCbCr444P) | \
				HIGHBIT(TEGRA_WIN_FMT_YUV444P) | \
				HIGHBIT(TEGRA_WIN_FMT_YCrCb420SP) | \
				...
				HIGHBIT(TEGRA_WIN_FMT_YUV422SP) | \
				HIGHBIT(TEGRA_WIN_FMT_YVU444SP) | \
				HIGHBIT(TEGRA_WIN_FMT_YUV444SP))
...
#define TEGRA_WIN_FMT_COMPRESSION_T210_LOW (BIT(TEGRA_WIN_FMT_B8G8R8A8) | \
				BIT(TEGRA_WIN_FMT_R8G8B8A8))
...
#define TEGRA_WIN_FMT_SIMPLE_T210_LOW (BIT(TEGRA_WIN_FMT_B4G4R4A4) | \
				BIT(TEGRA_WIN_FMT_B5G5R5A) | \
				BIT(TEGRA_WIN_FMT_B5G6R5) | \
				BIT(TEGRA_WIN_FMT_B8G8R8A8) | \
				BIT(TEGRA_WIN_FMT_R8G8B8A8))

#define TEGRA_WIN_FMT_SIMPLE_T210_HIGH (HIGHBIT(TEGRA_WIN_FMT_A8B8G8R8))
