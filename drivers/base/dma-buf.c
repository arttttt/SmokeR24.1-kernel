...
/* On this kernel show_fdinfo still returns int; upstream's void variant
 * arrives in 3.19. */
static int dma_buf_show_fdinfo(struct seq_file *m, struct file *file)
{
	...
	seq_printf(m, "count:\t%ld\n",
		   (long)(dmabuf->file->f_count.counter) - 1);
